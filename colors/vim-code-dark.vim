...
" Note, this file is heavily modified from the original
...
let s:cdFront = {'gui': '#F4F4F4', 'cterm': s:cterm05, 'cterm256': '188'}
...
let s:cdPopupFront = {'gui': '#DBDBDB', 'cterm': s:cterm06, 'cterm256': '250'}
...
let s:cdSplitLight = {'gui': '#A9A9A9', 'cterm': s:cterm04, 'cterm256': '245'}
let s:cdSplitDark = {'gui': '#646464', 'cterm': s:cterm03, 'cterm256': '238'}
let s:cdSplitThumb = {'gui': '#626262', 'cterm': s:cterm04, 'cterm256': '238'}
...
let s:cdLineNumber = {'gui': '#7A7A7A', 'cterm': s:cterm04, 'cterm256': '240'}
...
let s:cdDiffRedLight = {'gui': '#8F3333', 'cterm': s:cterm08, 'cterm256': '52'}
let s:cdDiffRedLightLight = {'gui': '#FB2121', 'cterm': s:cterm08, 'cterm256': '09'}
let s:cdDiffGreenDark = {'gui': '#373D29', 'cterm': s:cterm0B, 'cterm256': '237'}
if g:codedark_modern | let s:cdDiffGreenDark = {'gui': '#238636', 'cterm': 'NONE', 'cterm256': '237'} | endif
let s:cdDiffGreenLight = {'gui': '#6B2652', 'cterm': s:cterm09, 'cterm256': '58'}
let s:cdDiffBlueLight = {'gui': '#a7f7ff', 'cterm': s:cterm0C, 'cterm256': '117'}
